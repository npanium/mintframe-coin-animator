    ...
    <div className="flex flex-col gap-3">
      ...
      <Advanced>
        ...
        <Slider
          ...
          onChange={(v) => onChange({ rimWidth: v })}
        />
        <Slider
          label="Rim Step"
          min={0.002}
